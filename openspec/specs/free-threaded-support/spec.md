...
CI SHALL run the test suite against a free-threaded build of the supported interpreter, in addition to the default GIL-enabled build, and SHALL fail the build when the suite fails on either.
