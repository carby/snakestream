...
1. [A small source should reach more than one worker](items/spread-small-sources-across-workers.md) — filed 2026-09-06<br>  **Gate:** sequenced after ramp-batch-growth-geometrically, and verified by counting distinct worker threads — never by timing
2. [`Box` belongs with the collector containers](items/move-box-into-collectors.md) — filed 2026-09-03
