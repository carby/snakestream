...
1. [`Stream.of()`'s arity-dependent semantics](items/stream-of-arity-semantics.md) — filed 2026-08-20<br>  **Gate:** the break lands whole: `Stream.iterate()` rebuilt off the spreading form, every README example and test call site updated, and a README Migration entry, all in the same commit
